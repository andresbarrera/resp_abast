@extends('layouts.app')
@section('title')
ABAST | MODIFICAR TIPO DE LICENCIA
@stop
@push('javascript')
...
@section('content')
<section class="row">
	<h3 class="col-xs-12">Modificar Tipo de Licencia</h3>
</section>
<section class="row">
	<div class="col-xs-12">
		<hr />
...
<section class="row">
	<div class="col-xs-12">
		<form name="modificar" method="post" action="{{ URL::to('tiposlicencias/'.$tiposlicencias->id_tipolicencia) }}" role="form" class="form-horizontal">
			...
			<div class="form-group">
				<div class="col-sm-6 col-md-4">
					...
					<input type="text" name="tiposlicencias" value="{{ (old('tiposlicencias')) ? old('tiposlicencias') : $tiposlicencias->detalle_tipolicencia }}" class="form-control" id="detalle" autocomplete="off" placeholder="Detalle del tipo de licencia" autofocus="true" maxlength="50" style="<?php if ($errors->has('tiposlicencias')) {?> border: 1px solid #F00; <?php } ?>" />
