...
@section('title')
ABAST | MODIFICAR CENTRO DE COSTO
@stop
...
@section('content')
<section class="row">
	<h3 class="col-xs-12">Modificar Centro de Costo</h3>
</section>
<section class="row">
	<div class="col-xs-12">
		<hr/>
...
<section class="row">
	...
	<div class="col-xs-12">
		<form name="modificar" method="post" action="{{ URL::to('centroscostos/'.$centroscostos->id_centrocosto) }}" role="form" class="form-horizontal">
			...
			{{ csrf_field() }}
				<div class="col-sm-6 col-md-4">
					...
					<input type="text" name="centroscostos" value="{{ old('centroscostos') ? old('centroscostos') : $centroscostos->cod_centrocosto}}" class="form-control" id="centroscostos" autocomplete="off" placeholder="Código del centro de costo" autofocus="true" maxlength="50" style="<?php if ($errors->has('centroscostos')) {?> border: 1px solid #F00; <?php } ?>" />
				...
				<div class="col-sm-6 col-md-4">
	              ...
	              <div class="form-group">
	                ...
	                <div class="input-group date">
	                  ...
	                  <input type="text" class="form-control pull-right" id="fechainicio" name="fechainicio" value="{{old('fechainicio') ? old('fechainicio') : $fechainicio}}">
	                </div>
	                <!-- /.input group -->
	              </div>	
				</div>
				...
				<div class="col-sm-6 col-md-4">
	                ...
	                <div class="input-group date">
	                  ...
	                  <input type="text" class="form-control pull-right" id="fechafinal" name="fechafinal" value="{{old('fechafinal') ? old('fechafinal') : $fechafinal}}">
	                </div>
	                <!-- /.input group -->
	              </div>	
				</div>
				...
				<div class="col-sm-6 col-md-11">
					...
					<br>
					<textarea name="descripcion" id="descripcion" rows="10" cols="100" >{{ $centroscostos->descripcion_centrocosto }}</textarea>
				</div>
			<hr />
