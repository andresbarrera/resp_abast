...
@section('title')
ABAST | AGREGAR TIPO DE VEHICULO
@stop
...
@section('content')
<section class="row">
	<h3 class="col-xs-12">Agregar Tipo de Vehiculo</h3>
</section>
<section class="row">
	<div class="col-xs-12">
		<hr/>
...
<section class="row">
	<div class="col-xs-12">
		<form name="agregar" method="post" action="{{ URL::to('tiposvehiculos') }}" role="form" class="form-horizontal">
			{{ csrf_field() }}
			<div class="form-group">
				<div class="col-sm-6 col-md-4">
					<span class="required-asterik">*</span>
					<label for="tiposvehiculos" class="control-label">Tipo de Vehiculo</label>
					<input type="text" name="tiposvehiculos" value="{{ old('tiposvehiculos') }}" class="form-control" id="tiposvehiculos" autocomplete="off" placeholder="Nombre del tipo de vehiculo" autofocus="true" maxlength="50" style="<?php if ($errors->has('tiposvehiculos')) {?> border: 1px solid #F00; <?php } ?>" />
